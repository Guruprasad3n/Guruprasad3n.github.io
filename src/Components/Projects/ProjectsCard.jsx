...
const projects =[
{image:"https://3.bp.blogspot.com/-unh8D92TmRI/WOaB0KstnnI/AAAAAAAAt4g/DGI3qrYJUzk2U80UbCmJ28WJ2e3xHfB7wCLcB/s1600/bath%2Band%2Bbody%2Bworks%2Bapril%2B5%2B2017%2Bwebsite%2Bchanges.png", 
name:"Bath & Body Works", 
TechStacks:"HTML, CSS, Java Script",
description:"This is a Body-Care Ecommerce Website we Can Purchase in this website Body Care Products like Soaps, Sanitizers etc..",
github:"https://github.com/s10shashi/Bath-BodyWash",
netlify:"https://tranquil-salmiakki-c4ee29.netlify.app/"

},

{image:"https://bloghubstaffcom.lightningbasecdn.com/wp-content/uploads/2021/01/My-Hours@2x.png", 
name:"Myhours", 
TechStacks:"HTML, CSS, Java Script",
description:"MyHours - Clone; Our goal was replicate functionality where user can tracking time, maintain client details and can purchase plan according to the requirement",
...
projects.map((e)=>(
    <div className="project__content">
            ...
            <h3 className="project__title">{e.name}</h3>
    <p className="project__teck-stacks">{`Tech Stacks:-  ${e.TechStacks}`}</p>
            <span className="projects__button">View More <i className="uil uil-arrow-right projects__button-icon"></i> </span>
            <p className="project__description">{e.description}</p>
            <div className="buttons__github-netlify">
                <button><a className="netlify__github-button" href={e.github} target="_blank">Github</a></button>
                <button><a className="netlify__github-button" href={e.netlify} target="_blank">Netlify</a></button>
