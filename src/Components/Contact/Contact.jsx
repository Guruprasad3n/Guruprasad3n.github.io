...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_sfyw44u', 'template_opsmsi7', form.current, 'E7lI4vASDhV7aiXcy')
     e.target.reset()
  };
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <a target="_blank"
                href="mailto:guruprasad7652@gmail.com.com"
        ...
        <div className="contact__content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact__form">
            <div className="contact__form-div">
              <lebel className="contact__form-tag">Name</lebel>
              <input
                type="text"
                name="name"
            ...
            <div className="contact__form-div">
              <lebel className="contact__form-tag">Email</lebel>
              <input
                type="text"
                name="email"
                className="contact__form-input"
            ...
            <div className="contact__form-div">
              <lebel className="contact__form-tag">Subject</lebel>
              <input
                type="text"
                name="subject"
                className="contact__form-input"
            ...
            <div className="contact__form-div contact__form-area">
              <lebel className="contact__form-tag">Message</lebel>
              <textarea
                name="message"
                cols="30"
                rows="10"
