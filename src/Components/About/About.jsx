  ...
  return (
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
        <img src={myIng} alt="" className="about__img" />
        <div className="about__data">
          <AboutMe />
          <p className="about__description">
          Hi, My Name is Guru Prasad Behera I am Full Stack Web Developer and I enjoy learning new things in Web Development.
    </p>
          <a href={Resume}  download="Guruprasad-Behera-Resume" className="button button--flex" >Resume
          <svg
                class="button__icon"
